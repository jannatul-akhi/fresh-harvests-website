  ...
  return (
    <div>
      <div className="text-center">
        ...
        <p className="text-[#4A4A52] text-[.7rem] lg:text-[.87rem] font-normal mt-4">
          At Fresh Harvests, we are passionate about providing you with the
          freshest <br /> and most flavorful fruits and vegetables.
        </p>
      </div>
      {/* leaf  */}
      <div className="flex justify-end lg:mr-80 lg:-mt-30">
        <Image
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 font-rubik">
          {blogs.map((blog, index) => (
            ...
            >
              ...
              <div className="mt-4">
                <p className="text-lg text-[#4A4A52] font-light font-questrial">
                  {blog.date}
                </p>
